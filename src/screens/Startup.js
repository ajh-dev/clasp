...
import { Text, View, StyleSheet, Image, Dimensions, StatusBar, TouchableOpacity, ScrollView, Touchable } from 'react-native';
import {
    Arvo_400Regular,
    ...
    return (
        <>
            <StatusBar barStyle="dark-content" />
                ...
                >
                    ...
                    <View style={[styles.container, styles.blue]}>
                        ...
                        <Text style={styles.subHeader}>{'Cost free...\nand always ad-free'}</Text>
                    </View>
                    ...
                    <View style={[styles.container, styles.gray]}>
                        ...
                        <TouchableOpacity style={[styles.red, styles.signupButton]} onPress={() => navigation.navigate('SignupProfile')}>
                                <Text style={styles.subHeader}>create account</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.orange, styles.signupButton]} onPress={() => navigation.navigate('SignupID')}>
            ...
            <View style={styles.paginationWrapper}>
                ...
                <View style={[styles.paginationDots, { opacity: sliderState === index ? 1 : 0.2 }]} key={index} />
                ))}
            </View>
        </>
    );
