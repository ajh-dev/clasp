...
const sendMessage = async (newMessage, conversationID) => {
    try{
        const response = claspApi.send('/createmessage/' + conversationID, newMessage);
...
export const { Provider, Context } = createDataContext(messageReducer, { sendMessage, loadConversations, createConversation }, { error: '', conversations: []});